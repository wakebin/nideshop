...
module.exports = class extends Base {
  ...
  async detailAction() {
    ...
    const attribute = await this.model('goods_attribute').field('goods_attribute.value, attribute.name').join('attribute ON goods_attribute.attribute_id=attribute.id').order({'goods_attribute.id': 'asc'}).where({'goods_attribute.goods_id': goodsId}).select();
